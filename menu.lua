...
-- ===== КНОПКИ МЕНЮ =====
createToggle(0.12, "📡 ESP (подсветка игроков)", false)
createToggle(0.25, "🎯 Silent Aim (авто-прицел)", false)
createToggle(0.38, "👤 ESP Survivors", false)
createToggle(0.51, "👹 ESP Killers", false)
